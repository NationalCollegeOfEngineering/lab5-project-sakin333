        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">maharjan.sakin3@gmail.com</span>

              <a href="mailto:maharjan.sakin3@gmail.com?subject=Hello%20from%20Website" className="contact__button">Write me
            ...
            <div className="contact__card">
              ...
              <a href="https://m.me/suckin.mazon" target='_blank' className="contact__button">Write me
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
          </div>
